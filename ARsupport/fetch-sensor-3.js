...
this.el.addEventListener('markerLost', () => {
        ...
        var immagine = document.querySelector('#immagineprova2')
          ...
          element.setAttribute('gltf-model',"https://raw.githubusercontent.com/nicolocarpignoli/location-based-ar-tutorial/master/static-places/assets/dragonite/scene.gltf")
          immagine.setAttribute('scale', '0.002 0.002 0.002')
